<h1 align="center">
  <img src="https://github.com/user-attachments/assets/f0876646-da58-4a70-9f27-3df196de87e8" width="100%"/>
  <br/>
...
<p align="center">
  <a href="https://git.io/streak-stats">
    <img src="https://streak-stats.demolab.com?user=YOUR_USERNAME&theme=dark&border_radius=8&date_format=M%20j%5B%2C%20Y%5D" alt="GitHub Streak" />
  </a>
</p>
...
## 🔧 active_projects/
```txt
├── 🧬 kernel-mod-experiments/    # Breaking things to learn
├── 🎯 game-dev-prototypes/       # Where C++ meets creativity  
├── 🐍 automation-tools/          # Because repeating tasks is boring
└── 🔐 security-research/         # Breaking things (but ethically)
```
...
#define EMAIL     "dr4nyx404@hackerman.jupiter"
